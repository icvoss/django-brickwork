...
every shipped shell, component, section, archetype and skeleton: 6 shells, 50
components, 28 sections, 27 archetypes, 1 skeleton (112 items;
...
- But almost every ARCHETYPE (25 of 27; only `app/confirm.html` and
