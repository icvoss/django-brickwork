...
operations is complete at 7 of 7; Marketing and public web is complete at 7 of 7;
Product applications has shipped its INTERFACE-SYSTEM required eight (including
search and activity) and sits at 15 archetypes overall; remaining gaps live on
...
components, 32 sections, 46 archetypes, 1 skeleton (read the shipped
