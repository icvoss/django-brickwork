...
every shipped shell, component, section and archetype: 5 shells, 47
components, 26 sections, 18 archetypes (96 items; re-derived from a
regenerated manifest after both the scorecard/stat-comparison and the
queue/audit-trail work landed, 2026-08-28). The 40th component was
...
this document's original W0.2 baseline of 39 was written, and the 46th and
47th are `_scorecard.html` and `_stat_comparison.html`.
