...
Documentation and Editorial and publishing are complete at 7 of 7; Product
applications has shipped its INTERFACE-SYSTEM required eight (including search
and activity) and sits at 15 archetypes overall. Remaining gaps live on
...
components, 32 sections, 42 archetypes, 1 skeleton (read the shipped
