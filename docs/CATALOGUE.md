...
every shipped shell, component, section and archetype: 5 shells, 44
components, 26 sections, 16 archetypes (91 items; verified against the
tree post-trend-indicator work, 2026-08-27). The 40th component was
`_theme_switch.html` (W0.4, icvoss/django-brickwork#228), the 41st was
`_ranked_list.html` (#183), and the 42nd is `_chart_card.html`, shipped
after this document's original W0.2 baseline of 39 was written.
