...
every shipped shell, component, section, archetype and skeleton: 6 shells, 70
components, 32 sections, 52 archetypes, 1 skeleton (read the shipped
...
- A minority need list-of-dicts or other view-supplied data a template cannot
  build inline (`features/*` list shapes, `pricing/three-tier`,
