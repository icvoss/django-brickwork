...
every shipped shell, component, section, archetype and skeleton: 6 shells, 78
components, 35 sections, 52 archetypes, 1 skeleton (read the shipped
...
- A minority need list-of-dicts or other view-supplied data a template cannot
  build inline (`features/*` list shapes, `directory/numbered`,
  `methods/quiet-columns`, `pricing/three-tier`,
