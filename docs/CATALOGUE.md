...
| Archetype | A copy-paste example of a COMPLETE page | `examples/base.html`, `examples/app/*.html`, `examples/auth/*.html`, `examples/docs/*.html`, `examples/marketing/*.html`, `examples/ops/*.html` |
...
every shipped shell, component, section and archetype: 6 shells, 50
components, 28 sections, 23 archetypes (107 items; re-derived from a
regenerated manifest after the Documentation family's first two archetypes
landed, icvoss/django-brickwork#408 and icvoss/django-brickwork#409).
...
- But almost every ARCHETYPE (21 of 23; only `app/confirm.html` and
