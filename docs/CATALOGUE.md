...
every shipped shell, component, section, archetype and skeleton: 6 shells, 79
components, 36 sections, 52 archetypes, 1 skeleton (read the shipped
...
- A minority need list-of-dicts or other view-supplied data a template cannot
  ...
  `directory/numbered`, `methods/quiet-columns`, `pricing/three-tier`,
