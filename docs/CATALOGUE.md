...
every shipped shell, component, section and archetype: 5 shells, 40
components, 26 sections, 16 archetypes (87 items; verified against the
tree post-W0.1/W0.4 merge, 2026-08-25). The 40th component is
`_theme_switch.html` (W0.4, icvoss/django-brickwork#228), shipped after
this document's original W0.2 baseline of 39 was written.
