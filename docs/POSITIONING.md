...
| What runs | Scope |
|---|---|
| axe-core WCAG 2.2 AA scan | 176 documents across two fixture sets: 130 hand-maintained pages (65 fixtures x light and dark) plus 46 catalogue-document pages (23 catalogue documents, being 22 archetypes plus 1 skeleton, x light and dark), blocking every push (`a11y-gate` CI job) |
