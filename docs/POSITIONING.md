...
| What runs | Scope |
|---|---|
| axe-core WCAG 2.2 AA scan | 188 documents across two fixture sets: 132 hand-maintained pages (66 fixtures x light and dark) plus 56 catalogue-document pages (28 catalogue documents, being 27 archetypes plus 1 skeleton, x light and dark), blocking every push (`a11y-gate` CI job) |
...
| Version | 3.19.0 | consistent in `pyproject.toml` and `src/brickwork/__init__.py`. **Gated** |
