...
| What runs | Scope |
|---|---|
| axe-core WCAG 2.2 AA scan | 192 documents across two fixture sets: 136 hand-maintained pages (68 fixtures x light and dark) plus 56 catalogue-document pages (28 catalogue documents, being 27 archetypes plus 1 skeleton, x light and dark), blocking every push (`a11y-gate` CI job) |
