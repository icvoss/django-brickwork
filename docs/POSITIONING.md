...
`--bw-*` tokens exist (dated at 3.12.0), 294 overridable. 10 are load-bearing,
...
| Tokens | 358 unique `--bw-*` | 294 overridable; 10 load-bearing, 8 unconditional. **Overridable count gated** against `token-manifest.json`; the 358 total (all custom properties in compiled `tokens.css`) is **dated** at 3.12.0 |
