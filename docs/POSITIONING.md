...
| Sections | 43 | **Gated** against `catalogue-manifest.json` |
...
| Examples | 95 | 52 archetype pages, 43 sections. **Gated** against `catalogue-manifest.json` |
...
| Version | 4.1.0 | consistent in `pyproject.toml` and `src/brickwork/__init__.py`. **Gated** |
