...
| What runs | Scope |
|---|---|
| axe-core WCAG 2.2 AA scan | 210 documents across two fixture sets: 152 hand-maintained pages (76 fixtures x light and dark) plus 58 catalogue-document pages (29 catalogue documents, being 28 archetypes plus 1 skeleton, x light and dark), blocking every push (`a11y-gate` CI job) |
...
| Examples | 57 | 28 archetype pages, 29 sections. **Gated** against `catalogue-manifest.json` |
