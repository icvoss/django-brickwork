...
by touching component classes. 350 unique `--bw-*` tokens exist (dated at
3.12.0), 279 overridable. 10 are load-bearing, of which 8 are unconditional:
...
| Fact | Value | Note |
|---|---|---|
| Components | 44 | 35 core, 9 marketing. **Gated** against `catalogue-manifest.json` |
