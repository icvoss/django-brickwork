...
| Fact | Value | Note |
|---|---|---|
| Components | 78 | 56 core, 22 marketing. **Gated** against `catalogue-manifest.json` |
| Shells | 6 | base, app, auth, centred, docs, marketing. **Gated** against `catalogue-manifest.json` |
| Sections | 34 | **Gated** against `catalogue-manifest.json` |
...
| Examples | 86 | 52 archetype pages, 34 sections. **Gated** against `catalogue-manifest.json` |
