...
because the package ships 48 examples (21 pages, 27 sections) built from
...
**The composition proof.** 47 of the 48 examples are pure composition: zero
...
| What runs | Scope |
|---|---|
| axe-core WCAG 2.2 AA scan | 172 documents across two fixture sets: 130 hand-maintained pages (65 fixtures x light and dark) plus 42 archetype pages (21 catalogue archetypes x light and dark), blocking every push (`a11y-gate` CI job) |
...
| Examples | 48 | 21 archetype pages, 27 sections. **Gated** against `catalogue-manifest.json` |
