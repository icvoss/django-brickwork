...
| Fact | Value | Note |
|---|---|---|
| Components | 79 | 56 core, 23 marketing. **Gated** against `catalogue-manifest.json` |
...
| Version | 3.35.0 | consistent in `pyproject.toml` and `src/brickwork/__init__.py`. **Gated** |
