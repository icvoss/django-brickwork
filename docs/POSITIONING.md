...
| What runs | Scope |
|---|---|
| axe-core WCAG 2.2 AA scan | 166 documents across two fixture sets: 124 hand-maintained pages (62 fixtures x light and dark) plus 42 archetype pages (21 catalogue archetypes x light and dark), blocking every push (`a11y-gate` CI job) |
