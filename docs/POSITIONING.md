...
| What runs | Scope |
|---|---|
| axe-core WCAG 2.2 AA scan | 162 documents across two fixture sets: 122 hand-maintained pages (61 fixtures x light and dark) plus 40 archetype pages (20 catalogue archetypes x light and dark), blocking every push (`a11y-gate` CI job) |
...
| Archetypes | 20 | **Gated** against `catalogue-manifest.json` |
...
| Examples | 46 | 20 archetype pages, 26 sections. **Gated** against `catalogue-manifest.json` |
