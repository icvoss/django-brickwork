...
| What runs | Scope |
|---|---|
| axe-core WCAG 2.2 AA scan | 208 documents across two fixture sets: 150 hand-maintained pages (75 fixtures x light and dark) plus 58 catalogue-document pages (29 catalogue documents, being 28 archetypes plus 1 skeleton, x light and dark), blocking every push (`a11y-gate` CI job) |
...
| Fact | Value | Note |
|---|---|---|
| Components | 66 | 50 core, 16 marketing. **Gated** against `catalogue-manifest.json` |
