...
because the package ships 50 examples (23 pages, 27 sections) built from
...
| Fact | Value | Note |
|---|---|---|
| Components | 49 | 40 core, 9 marketing. **Gated** against `catalogue-manifest.json` |
| Shells | 6 | base, app, auth, centred, docs, marketing. **Gated** against `catalogue-manifest.json` |
| Sections | 27 | **Gated** against `catalogue-manifest.json` |
...
| Examples | 50 | 23 archetype pages, 27 sections. **Gated** against `catalogue-manifest.json` |
