...
| What runs | Scope |
|---|---|
| axe-core WCAG 2.2 AA scan | 206 documents across two fixture sets: 148 hand-maintained pages (74 fixtures x light and dark) plus 58 catalogue-document pages (29 catalogue documents, being 28 archetypes plus 1 skeleton, x light and dark), blocking every push (`a11y-gate` CI job) |
...
| Fact | Value | Note |
|---|---|---|
| Components | 65 | 49 core, 16 marketing. **Gated** against `catalogue-manifest.json` |
