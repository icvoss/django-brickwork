...
| What runs | Scope |
|---|---|
| axe-core WCAG 2.2 AA scan | 204 documents across two fixture sets: 146 hand-maintained pages (73 fixtures x light and dark) plus 58 catalogue-document pages (29 catalogue documents, being 28 archetypes plus 1 skeleton, x light and dark), blocking every push (`a11y-gate` CI job) |
...
| Version | 3.28.0 | consistent in `pyproject.toml` and `src/brickwork/__init__.py`. **Gated** |
