...
do not claim examples alone proved beauty. Brickwork ships 60
examples (31 archetype pages, 29 sections; a 61st file, `base.html`, is a
copied document skeleton). 59 of the 61 files add no CSS. The date range
...
axe-core WCAG 2.2 AA scan across 216 documents (152 hand-maintained fixtures
plus 64 catalogue-document pages, being 32 catalogue documents, 31 archetypes
...
> Status: **stable**. This checkout is version 3.31.0 (`pip install
