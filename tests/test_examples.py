...
_EXAMPLE_CTA_HREFS: dict[str, list[str]] = {
    ...
    "marketing/campaign.html": ["/accounts/signup/?offer=q4-2026", "/contact/"],
    "marketing/contact.html": ["/accounts/signup/"],
    "marketing/conversion.html": ["/accounts/signup/"],
}
