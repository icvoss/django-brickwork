...
_VOCABULARIES: list[tuple[str, str, str, str]] = [
    ...
    # there is no CSS rule to pin, only the byte-identity test in
    # test_marketing.py.
    ("_cta", "align", "start", "bw-cta--align-start"),
    # --- stat_band align (#673) ---------------------------------------------
    # "center" is the honestly-named default (the pre-existing centred
    # layout) and emits no modifier class at all, so it has no entry here:
    # there is no CSS rule to pin, only the byte-identity test in
    ...
    ("_card", "surface", "raised", "bw-card--surface-raised"),
    ("_card", "surface", "tint", "bw-card--surface-tint"),
    ("_card", "surface", "inverse", "bw-card--surface-inverse"),
    ("_card", "surface", "muted", "bw-card--surface-muted"),
    ("_card", "elevation", "0", "bw-card--elevation-0"),
    ("_card", "elevation", "2", "bw-card--elevation-2"),
    ("_card", "elevation", "3", "bw-card--elevation-3"),
    ("_card", "header_recipe", "bordered", "bw-card__header--bordered"),
    ("_card", "header_recipe", "muted", "bw-card__header--muted"),
    ("_card", "header_recipe", "inverse", "bw-card__header--inverse"),
    ("_card", "header_recipe", "accent", "bw-card__header--accent"),
    ("_card", "footer_recipe", "muted", "bw-card__footer--muted"),
    ("_card", "footer_recipe", "actions", "bw-card__footer--actions"),
    ("_card", "radius", "sm", "bw-card--radius-sm"),
    ("_card", "radius", "xl", "bw-card--radius-xl"),
    ("_card", "radius", "none", "bw-card--radius-none"),
    ("_card", "media_recipe", "bleed", "bw-card__media--bleed"),
    ("_card", "media_recipe", "inset", "bw-card__media--inset"),
