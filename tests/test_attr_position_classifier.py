...
_KNOWN_EXEMPT: dict[str, int] = {
    "components/_account_menu.html|aria-label|bw_account_menu_label": 1,
    "components/_alert.html|aria-label|bw_alert_close_label": 1,
    "components/_avatar_group.html|aria-label|bw_avatar_group_label": 1,
    "components/_badge.html|aria-label|bw_badge_close_label": 1,
    "components/_button.html|aria-label|aria_label": 3,
    ...
    "components/_chip.html|aria-label|bw_chip_close_label": 1,
    "components/_code.html|aria-label|bw_code_copy_label": 1,
    ...
    "components/_dropdown.html|aria-label|aria_label": 1,
    "components/_dropdown.html|aria-label|aria_label|trigger_label_attr": 1,
    ...
    "components/_gauge.html|aria-label|label": 1,
    "components/_gauge.html|r|radius": 2,
    "components/_ranked_list.html|aria-label|label": 1,
    "components/_ranked_list.html|href|row.href": 1,
    "components/_search.html|aria-label|search_label": 1,
    ...
    "components/_theme_switch.html|aria-label|label": 1,
    ...
    "components/_toast.html|aria-label|bw_toast_close_label": 1,
    ...
    "components/_version_switch.html|aria-label|landmark_label_attr": 1,
    "components/_version_switch.html|aria-label|summary_aria_label": 1,
    ...
    "shell/app.html|aria-label|bw_sidebar_collapse_label": 1,
