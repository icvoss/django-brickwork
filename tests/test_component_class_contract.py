...
_COMPONENT_RENDERS: dict[str, Callable[[], str]] = {
    ...
    "_portrait (marketing: start, flat CTAs)": lambda: _include(
        "brickwork_marketing/components/_portrait.html",
        name="Ada Lovelace",
        role="Analytical Engine",
        body="Notes on the loom.",
        image="<img src='/static/ada.jpg' alt='Ada Lovelace'>",
        align="start",
        primary_cta_label="Book a conversation",
        primary_cta_href="/contact/",
    ),
    "_portrait (marketing: end)": lambda: _include(
        "brickwork_marketing/components/_portrait.html",
        name="Ada Lovelace",
        image="<img src='/static/ada.jpg' alt='Ada Lovelace'>",
        align="end",
    ),
    "_bio (marketing: article foot)": lambda: _include(
