...
const RENAMES = new Map([
  ...
  ["bw-docs-nav-inline-size", "bw-component-docs-nav-inline-size"],
  ["bw-section-gap-marketing", "bw-component-section-gap-marketing"],
  ["bw-hero-copy-max-width", "bw-component-hero-copy-max-width"],
  ...
  ["bw-gauge-diameter-sm", "bw-component-gauge-diameter-sm"],
  ["bw-gauge-diameter-md", "bw-component-gauge-diameter-md"],
  ["bw-gauge-diameter-lg", "bw-component-gauge-diameter-lg"],
  ["bw-gauge-stroke-width", "bw-component-gauge-stroke-width"],
  ["bw-scorecard-columns-base", "bw-component-scorecard-columns-base"],
  ["bw-scorecard-columns-sm", "bw-component-scorecard-columns-sm"],
  ["bw-scorecard-columns-lg", "bw-component-scorecard-columns-lg"],
