...
// be real anchors, and the native <details> mobile drawer must be present.
test.describe("no-JS floor", () => {
  test.use({ javaScriptEnabled: false });

  test("shell renders and is navigable with JS disabled", async ({ page }) => {
    await page.goto(pathToFileURL(join(FIXTURES, "list-light.html")).href);
  ...
  test("form errors are present and wired with JS disabled", async ({ page }) => {
    await page.goto(pathToFileURL(join(FIXTURES, "form-errors-light.html")).href);
