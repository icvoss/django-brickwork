- **A prev/next pager treatment for sequential documents**
  ...
  the docs footer's own secondary tier: muted colour plus a real underline,
  beating the footer's zero-specificity `text-decoration: none` rule
  cleanly with no `!important`, and deliberately short of restoring the full
  prose link tier. Direction is carried in the link's own visible text
